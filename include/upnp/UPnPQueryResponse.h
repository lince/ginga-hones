...
#ifndef _UPNPQUERYRESPONSE_H
#define	_UPNPQUERYRESPONSE_H
                ...
                namespace hones {
                    namespace upnp {
                        ...
                        public:
                            ...
                            /**
                             * Configura a variável de estado retornada da consulta.
                             * @param var variável de estado.
                             */
                            void setUPnPStateVariable(UPnPStateVariable* var);

                            /**
                             * Retorna a variável de estado consultada.
                             * @return variável de estado consultada.
                             */
                            UPnPStateVariable* getUPnPStateVariable();

                            /**
                             * Configura o código e a descrição de erro na consulta à variável de estado.
                            ...
                            /**
                             * Configura o valor retornado.
                             * @param value valor retornado.
                             */
                            void setValueReceived(const char* value);

                            /**
                             * Retorna o valor recebido após a consulta.
                             * @return valor recebido após a consulta.
                             */
                            const char* getValueReceived();
