...
#ifndef _TVRCONNECTIONMANAGER_H
#define	_TVRCONNECTIONMANAGER_H
            ...
            namespace ginga {
                namespace hones {
                    namespace mediarenderer {
                        ...
                        class TVRConnectionManager : public UPnPActionListener, public UPnPQueryListener {
                        private:
                            TVRenderer *tvRender;
                            HLoggerPtr logger;
                        ...
                        public:
                            ...
                            TVRConnectionManager(TVRenderer *tvr);

                            ~TVRConnectionManager();
                            ...
                            /**
                             * Envia informações sobre uma conexão ativa do serviço de apresentação, tais como protocolo e direção.
                             *
                             * Argumentos de entrada da ação:
                             *      - ConnectionID
                             *
